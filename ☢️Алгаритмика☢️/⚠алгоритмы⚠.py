...
class Triangle:
    ...
    def answer(self):
        ...
        elif ((self.a == self.b) and (self.a != self.c and self.b != self.c)) or (
                (self.a == self.c) and (self.a != self.b and self.b != self.c)) or (
                (self.c == self.b) and (self.a != self.c and self.b != self.a)):
